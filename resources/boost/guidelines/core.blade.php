...
- After every feature or change, run `composer check` to verify static analysis, formatting, and tests pass. If it reports formatting failures, run `composer format`, then rerun `composer check`.
